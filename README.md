This project focuses on building a machine learning regression model using a Random Forest Regressorto predict numerical values based on input features. 
